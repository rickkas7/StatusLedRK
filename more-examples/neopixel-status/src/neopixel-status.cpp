...
#include "neopixel.h" // Must be before StatusLEDRK.h
...
const pin_t neopixelPin = D3;
Adafruit_NeoPixel strip(1, neopixelPin, WS2812B);

StatusLedRK_Neopixel statusLed(&strip);
